...
const HeroSection = () => {
  return (
    <section id='home' className="w-full min-h-screen  p-5 flex flex-col-reverse  lg:flex-row">
      {/* Left - Text Section */}
      <motion.div 
  ...
  />
        ...
        <div className="flex md:flex-row flex-col gap-5 text-base md:text-xl">
          <a className="flex items-center text-[#F1F5F9] gap-2 font-semibold" href=""><FaLocationDot color="#38BDF8" size={22} />Tenkasi</a>
          <a className="flex items-center text-[#F1F5F9] gap-2 font-semibold" href="tel:+91 9894175227"><IoCallSharp color="#38BDF8" size={22} />9894175227</a>
          <a className="flex items-center text-[#F1F5F9] gap-2 font-semibold" href="mailto:mohammedribai21601@gmail.com"><IoMdMail color="#38BDF8" size={22} />mohammedribai21601@gmail.com</a>
        </div>
        <button>
        <a
...
>
  Download CV
      ...
      className="w-full lg:w-1/2 h-[90%] flex relative  justify-center items-center">
        <FaReact size={50} className="absolute left-[10%] top-[5%] md:left-[20%] text-[#38BDF8] opacity-30 animate-spinner md:top-10"/>
        <FaHtml5 size={50} className="absolute text-[#38BDF8] opacity-10 animate-pulse md:left-[10%] md:top-[60%] bottom-[40%] left-0"/>
        <FaNodeJs size={50} className="absolute text-[#38BDF8] opacity-30 animate-spinner right-[10%] top-[90%]"/>
        <FaCss3 size={50} className="absolute text-[#38BDF8] opacity-10 animate-pulse   right-[10%] top-[5%]"/>
        <img
          src={hero}
          alt="Hero"
